...
<html>
    ...
    <body>
        ...
        <section id="description"> 
            <aside id="desc"><h3>Edit an Employee </h3> </aside>
                    ...
                    <fieldset  >
                        ...
                        <%
                            if (request.getMethod()=="POST"){
                                ...
                                out.write("Updated " + g.editEmp() + " record<br>");
                            }
                        %>
                        ...
                        <br>
                        Email :<br>
                        <input type="text" name="email" value="bashayer@yahoo.com">


                        <br>

                        Country:<br>
                        <input type="text" name="cont" value="Japan">
                        <br>

                        Password :<br>
                        <input type="password" name="pass" value="bashayer">
                        <br>
