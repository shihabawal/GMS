                    ...
                    <fieldset  >
                        ...
                        <%
                            if (request.getMethod()=="POST"){
                                ...
                                g.setPercentage(Double.parseDouble(request.getParameter("percentage")));
                                out.write("Updated " + g.editBin() + " record<br>");
                            }
                        %>
                        Bin ID:<br>
                        ...
                        <br>
                        Emirate :<br>
                        <input type="text" name="emirate" value="Dubai">
                        <br>

                        Area:<br>
                        <input type="text" name="area" value="Emitates">
                        <br>

                        Latitude:<br>
                        <input type="text" name="lat" value="52.32456">
                        <br>
                        
                        Longitude:<br>
                        <input type="text" name="lng" value="25.32523">
                        <br>
                        
                        Percentage:<br>
                        <input type="text" name="percentage" value="22.3">%
                        <br>
